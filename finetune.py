...
from msadata import MSADataSet, DataCollatorForMSA
from model import MSA_AUGMENTOR
from vocab import WordVocab
from torch.utils.data import Dataset, DataLoader, random_split # gx
...
class DataTrainingArguments:
    ...
    vocab: classmethod = field(
        default=None,
        metadata={"help": "vocab for the training"},
    )
